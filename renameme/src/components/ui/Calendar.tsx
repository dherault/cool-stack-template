  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-blue text-white hover:bg-blue hover:text-white dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900',
